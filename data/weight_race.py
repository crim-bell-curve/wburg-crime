...
f_asian = [ int(round(i / j * 100)) for i,j in zip(w_asian, totals) ]
f_black = [ int(round(i / j * 100)) for i,j in zip(w_black, totals) ]
f_white = [ int(round(i / j * 100)) for i,j in zip(w_white, totals) ]
